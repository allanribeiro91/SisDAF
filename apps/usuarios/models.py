...
class Usuario(models.Model):
    ...
    @classmethod
    def usuarios_por_unidade(cls, unidade):
        # Obter usuários com alocações ativas na unidade especificada
        usuarios = cls.objects.filter(
            alocacao__unidade=unidade,
            alocacao__is_ativo=True,
            usuario_is_ativo=True,
            del_status=False
        ).distinct()

        # Criar uma lista de dicionários contendo id e nome dos usuários
