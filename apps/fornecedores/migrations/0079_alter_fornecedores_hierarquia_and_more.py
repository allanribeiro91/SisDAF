...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('fornecedores', '0078_alter_fornecedores_hierarquia_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='fornecedores',
            name='porte',
            field=models.CharField(choices=[('me', 'ME'), ('mei', 'MEI'), ('epp', 'EPP'), ('grande_empresa', 'Grande Empresa'), ('medio_porte', 'Médio Porte'), ('demais', 'Demais')], max_length=20),
        ),
        migrations.AlterField(
            model_name='fornecedores',
            name='tipo_direito',
