...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('fornecedores', '0057_alter_fornecedores_porte'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='fornecedores',
            name='porte',
            field=models.CharField(choices=[('me', 'ME'), ('mei', 'MEI'), ('grande_empresa', 'Grande Empresa'), ('medio_porte', 'Médio Porte'), ('demais', 'Demais'), ('epp', 'EPP')], max_length=20),
        ),
        migrations.AlterField(
            model_name='fornecedores',
            name='tipo_direito',
